...
<div style="text-align: center;">
    ...
    <form action="search" method="post">
        <input type="text" placeholder="pesquisa" name="searchTerm" required><br>
        <button type="submit"><i class="fa fa-search"></i> Pesquisar</button>
    </form>

    Resultado:<br>

    <jsp:useBean id="resultado" class="webServer.Action.SearchAction">
        <jsp:setProperty name="resultado" property="*"/>
    </jsp:useBean>

    <% ArrayList<Webpage> web = resultado.getSearch().search(resultado.getSearchTerm()); %>
