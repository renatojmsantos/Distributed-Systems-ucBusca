...
public class SearchBean extends Bean {
    ...
    public ArrayList<Webpage> search(String term) throws RemoteException {
        String str;
        String codigo = new String();
        codigo = codigo.concat("type | search ;");
        codigo = codigo.concat(" search_term | "+term);
        ...
        */
        /*System.ou1t.println(str);
        str = str.replace("\n","<br>");
        str = str.replace("type | status ; msg | Pesquisa realizada s/conta"," ");*/
